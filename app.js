...
app.use(session({
    ...
    //Session exprires after one week of inactivity
...
app.get('/login', (req, res)=>{
    ...
    res.render('login', {
        messages: req.flash('success'), //retrieve success messages from session and pass to view
        errors: req.flash('error') //retrieve error messages from session and pass to view
    });
});
